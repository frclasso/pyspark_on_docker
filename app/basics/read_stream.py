...
# data = '/datasets/fake_patient_visit_data.csv'
data = '/Users/BlueShift/MyDocs/pessoal/estudos/tutoriais/medium/spark_on_docker/datasets/fake_patient_visit_data.csv' 
